...
INSERT INTO pets (id, shop_id, species_id, breed_id, name, gender, age_months, color, weight_kg, description, health_status, vaccination_status, price, status, created_at, updated_at) VALUES
...
('99999999-9999-9999-9999-999999999992', '44444444-4444-4444-4444-444444444444', '77777777-7777-7777-7777-777777777771', '88888888-8888-8888-8888-888888888882', 'Kuma', 'Female', 10, 'Red', 4.10, 'Shiba Inu lanh lợi, thích hợp nuôi trong nhà.', 'Khỏe mạnh, ăn uống tốt.', 'Đã tiêm phòng đầy đủ.', 12500000, 'AVAILABLE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('99999999-9999-9999-9999-999999999993', '44444444-4444-4444-4444-444444444444', '77777777-7777-7777-7777-777777777772', '88888888-8888-8888-8888-888888888883', 'Luna', 'Female', 6, 'Gray', 2.80, 'Mèo British Shorthair hiền, dễ chăm.', 'Khỏe mạnh, lông bóng mượt.', 'Đã tiêm phòng và tẩy giun.', 7200000, 'AVAILABLE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;

INSERT INTO pet_images (id, pet_id, image_url, is_thumbnail, created_at) VALUES
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1', '99999999-9999-9999-9999-999999999991', 'https://images.example.local/pets/milo-1.jpg', TRUE, CURRENT_TIMESTAMP),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '99999999-9999-9999-9999-999999999991', 'https://images.example.local/pets/milo-2.jpg', FALSE, CURRENT_TIMESTAMP),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '99999999-9999-9999-9999-999999999992', 'https://images.example.local/pets/kuma-1.jpg', TRUE, CURRENT_TIMESTAMP),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa4', '99999999-9999-9999-9999-999999999993', 'https://images.example.local/pets/luna-1.jpg', TRUE, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO cart_items (id, cart_id, pet_id, price, created_at) VALUES
('cccccccc-cccc-cccc-cccc-ccccccccccc1', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '99999999-9999-9999-9999-999999999991', 8500000, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO order_items (id, order_id, pet_id, pet_name, price, created_at) VALUES
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeee1', 'dddddddd-dddd-dddd-dddd-dddddddddddd', '99999999-9999-9999-9999-999999999991', 'Milo', 8500000, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;
